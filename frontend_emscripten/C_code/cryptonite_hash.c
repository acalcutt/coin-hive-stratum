...
int scanhash_cryptonight(char* pdata, uint32_t target, uint32_t max_nonce, uint32_t* last_nonce, uint64_t* hashes_done)
{
...
int mine(char* data, uint32_t* target, uint32_t maxNonce, char* proof){
  uint32_t nonce;
  uint32_t hashes_done;

  int ok = scanhash_cryptonight(
    data,
    target,
    maxNonce,
    &nonce,
